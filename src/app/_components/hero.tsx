      ...
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            The Niche stands as a beacon of innovation and expertise. Our tailored strategies, propel businesses to new heights in the online realm, we redefine success in the digital era.
            </p>
      ...
      <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            Trusted by <span className="text-indigo-600">30+</span>{" "}
            customers worldwide
          </div>
